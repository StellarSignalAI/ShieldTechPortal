...
function CustomerOnboardingTab({ customer, showToast }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <GlassPanel style={{ borderLeft: '3px solid var(--brand)', padding: 12 }}><div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><span>⟡</span><span style={{ fontSize: 12, color: 'var(--brand)' }}>ShieldTech AI: Next step is "{steps.find(s => !s.done)?.label || 'All complete!'}". Want me to send a reminder or schedule it?</span></div></GlassPanel>
    </div>
  );
}
...
function CustomerStatusTab({ customer, showToast }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      <GlassPanel style={{ borderLeft: '3px solid var(--brand)', padding: 12 }}><div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><span>⟡</span><span style={{ fontSize: 12, color: 'var(--brand)' }}>Auto-generated by ShieldTech AI — visible to {c.name} in their Customer Portal. Updates in real-time.</span></div></GlassPanel>
